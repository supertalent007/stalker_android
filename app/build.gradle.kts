...
android {
  ...
  defaultConfig {
    ...
    buildConfigField("String", "SIGNAL_CDSI_URL", "\"https://stalkerappazure.net\"")
    ...
    buildConfigField("String", "CDSI_MRENCLAVE", "\"f2a2087393ad60e5fbed59dc9bcfe3712645a8eae6622f2b7c707b4bc2831a4f\"")
