...
android {
  namespace = "org.stalker.securesms"
  ...
  defaultConfig {
    ...
    buildConfigField("String", "SIGNAL_URL", "\"https://stalkerapp.io\"")
    buildConfigField("String", "STORAGE_URL", "\"https://storage.signal.org\"")
    buildConfigField("String", "SIGNAL_CDN_URL", "\"https://cdn.signal.org\"")
    buildConfigField("String", "SIGNAL_CDN2_URL", "\"https://cdn2.signal.org\"")
    buildConfigField("String", "SIGNAL_CDN3_URL", "\"https://cdn3.signal.org\"")
    buildConfigField("String", "SIGNAL_CDSI_URL", "\"https://stalkerappazure.com\"")
    ...
    buildConfigField("String", "CDSI_MRENCLAVE", "\"0f4a00ddacd699bbf3782b7bf9d95b2f2d6290f1bfdee65a8aca6294c084045e\"")
    buildConfigField("String", "SVR2_MRENCLAVE", "\"a6622ad4656e1abcd0bc0ff17c229477747d2ded0495c4ebee7ed35c1789fa97\"")
    buildConfigField("String", "UNIDENTIFIED_SENDER_TRUST_ROOT", "\"BY/MJfl0LWPej6JobkMLc51OQVuc6zQoM1N8Q6oKZ38F\"")
    ...
    buildConfigField("String", "SIGNAL_CAPTCHA_URL", "\"https://stalkerapp.io/signalcaptchas/index.html\"")
    buildConfigField("String", "RECAPTCHA_PROOF_URL", "\"https://stalkerapp.io/signalcaptchas/index.html\"")
    ...
    testInstrumentationRunner = "org.stalker.securesms.testing.SignalTestRunner"
  ...
  productFlavors {
    ...
    create("staging") {
      ...
      buildConfigField("String", "UNIDENTIFIED_SENDER_TRUST_ROOT", "\"gJ/DDKRerobCwaOE+o0hFYYmEQD+MzOufhCXNkf2Jkc=\"")
