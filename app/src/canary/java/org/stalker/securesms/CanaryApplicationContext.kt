  ...
  override fun onCreate() {
    ...
    LeakCanary.config = LeakCanary.config.copy(
      referenceMatchers = AndroidReferenceMatchers.appDefaults +
        ...
        AndroidReferenceMatchers.ignoredInstanceField(
          className = "org.stalker.securesms.components.voice.VoiceNotePlaybackService",
          fieldName = "mApplication"
        ) +
        AndroidReferenceMatchers.ignoredInstanceField(
          className = "org.stalker.securesms.service.GenericForegroundService\$LocalBinder",
          fieldName = "this\$0"
        ) +
        AndroidReferenceMatchers.ignoredInstanceField(
          className = "org.stalker.securesms.contacts.ContactsSyncAdapter",
          fieldName = "mContext"
        )
    )
  }
