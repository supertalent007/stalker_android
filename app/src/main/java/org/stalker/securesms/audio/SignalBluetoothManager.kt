...
import org.stalker.securesms.util.safeUnregisterReceiver
import org.stalker.securesms.webrtc.audio.SignalAudioHandler
 ...
 * reports that to the [org.stalker.securesms.webrtc.audio.SignalAudioManager], and then handles connecting/disconnecting
 * to the device if requested by [org.stalker.securesms.webrtc.audio.SignalAudioManager].
 */
