...
import org.stalker.securesms.avatar.picker.AvatarPickerItem
import org.stalker.securesms.components.BoldSelectionTabItem
import org.stalker.securesms.components.ControllableTabLayout
...
class TextAvatarCreationFragment : Fragment(R.layout.text_avatar_creation_fragment) {
  ...
  companion object {
    const val REQUEST_KEY_TEXT = "org.stalker.securesms.avatar.text.TEXT"
  }
}
