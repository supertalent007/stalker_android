...
package org.stalker.securesms.components.settings.app.appearance.appicon.util
...
enum class AppIconPreset(private val componentName: String, @DrawableRes val iconPreviewResId: Int, @StringRes val labelResId: Int) {
  ...
  fun getComponentName(context: Context): ComponentName {
    ...
    return ComponentName(applicationContext, "org.stalker.securesms" + componentName)
  }
}
