...
import org.stalker.securesms.BlockUnblockDialog
import org.stalker.securesms.GroupMembersDialog
import org.stalker.securesms.LoggingFragment
import org.stalker.securesms.MainActivity
import org.stalker.securesms.MuteDialog
import org.stalker.securesms.R
import org.stalker.securesms.audio.AudioRecorder
import org.stalker.securesms.badges.gifts.OpenableGift
import org.stalker.securesms.badges.gifts.OpenableGiftItemDecoration
import org.stalker.securesms.badges.gifts.flow.GiftFlowActivity
import org.stalker.securesms.badges.gifts.viewgift.received.ViewReceivedGiftBottomSheet
import org.stalker.securesms.badges.gifts.viewgift.sent.ViewSentGiftBottomSheet
import org.stalker.securesms.components.AnimatingToggle
import org.stalker.securesms.components.ComposeText
import org.stalker.securesms.components.ConversationSearchBottomBar
import org.stalker.securesms.components.HidingLinearLayout
import org.stalker.securesms.components.InputAwareConstraintLayout
import org.stalker.securesms.components.InputPanel
import org.stalker.securesms.components.InsetAwareConstraintLayout
import org.stalker.securesms.components.ProgressCardDialogFragment
import org.stalker.securesms.components.ProgressCardDialogFragmentArgs
import org.stalker.securesms.components.ScrollToPositionDelegate
import org.stalker.securesms.components.SendButton
...
import org.stalker.securesms.components.mention.MentionAnnotation
import org.stalker.securesms.components.menu.ActionItem
import org.stalker.securesms.components.menu.SignalBottomActionBar
import org.stalker.securesms.components.settings.app.subscription.donate.DonateToSignalFragment
import org.stalker.securesms.components.settings.app.subscription.donate.DonateToSignalType
import org.stalker.securesms.components.settings.conversation.ConversationSettingsActivity
import org.stalker.securesms.components.spoiler.SpoilerAnnotation
...
import org.stalker.securesms.contacts.paged.ContactSearchKey.RecipientSearchKey
import org.stalker.securesms.contactshare.Contact
import org.stalker.securesms.contactshare.ContactUtil
import org.stalker.securesms.contactshare.SharedContactDetailsActivity
import org.stalker.securesms.conversation.AttachmentKeyboardButton
import org.stalker.securesms.conversation.BadDecryptLearnMoreDialog
import org.stalker.securesms.conversation.ConversationAdapter
import org.stalker.securesms.conversation.ConversationBottomSheetCallback
...
import org.stalker.securesms.conversation.ConversationIntents.ConversationScreenType
import org.stalker.securesms.conversation.ConversationItem
import org.stalker.securesms.conversation.ConversationItemSelection
import org.stalker.securesms.conversation.ConversationItemSwipeCallback
import org.stalker.securesms.conversation.ConversationMessage
import org.stalker.securesms.conversation.ConversationOptionsMenu
import org.stalker.securesms.conversation.ConversationReactionDelegate
import org.stalker.securesms.conversation.ConversationReactionOverlay
import org.stalker.securesms.conversation.ConversationReactionOverlay.OnActionSelectedListener
import org.stalker.securesms.conversation.ConversationReactionOverlay.OnHideListener
import org.stalker.securesms.conversation.ConversationSearchViewModel
import org.stalker.securesms.conversation.ConversationUpdateTick
import org.stalker.securesms.conversation.MarkReadHelper
import org.stalker.securesms.conversation.MenuState
import org.stalker.securesms.conversation.MessageSendType
import org.stalker.securesms.conversation.MessageStyler.getStyling
import org.stalker.securesms.conversation.ReenableScheduledMessagesDialogFragment
import org.stalker.securesms.conversation.ScheduleMessageContextMenu
import org.stalker.securesms.conversation.ScheduleMessageDialogCallback
import org.stalker.securesms.conversation.ScheduleMessageTimePickerBottomSheet
import org.stalker.securesms.conversation.ScheduleMessageTimePickerBottomSheet.Companion.showSchedule
import org.stalker.securesms.conversation.ScheduledMessagesBottomSheet
import org.stalker.securesms.conversation.ScheduledMessagesRepository
import org.stalker.securesms.conversation.SelectedConversationModel
import org.stalker.securesms.conversation.ShowAdminsBottomSheetDialog
...
import org.stalker.securesms.conversation.drafts.DraftRepository
import org.stalker.securesms.conversation.drafts.DraftRepository.ShareOrDraftData
import org.stalker.securesms.conversation.drafts.DraftViewModel
import org.stalker.securesms.conversation.mutiselect.ConversationItemAnimator
import org.stalker.securesms.conversation.mutiselect.MultiselectItemDecoration
import org.stalker.securesms.conversation.mutiselect.MultiselectPart
import org.stalker.securesms.conversation.mutiselect.forward.MultiselectForwardBottomSheet
...
import org.stalker.securesms.conversation.quotes.MessageQuotesBottomSheet
import org.stalker.securesms.conversation.ui.edit.EditMessageHistoryDialog
import org.stalker.securesms.conversation.ui.error.EnableCallNotificationSettingsDialog
import org.stalker.securesms.conversation.ui.inlinequery.InlineQuery
import org.stalker.securesms.conversation.ui.inlinequery.InlineQueryChangedListener
import org.stalker.securesms.conversation.ui.inlinequery.InlineQueryReplacement
import org.stalker.securesms.conversation.ui.inlinequery.InlineQueryResultsControllerV2
import org.stalker.securesms.conversation.ui.inlinequery.InlineQueryViewModelV2
import org.stalker.securesms.conversation.v2.computed.ConversationMessageComputeWorkers
import org.stalker.securesms.conversation.v2.data.ConversationMessageElement
import org.stalker.securesms.conversation.v2.groups.ConversationGroupCallViewModel
import org.stalker.securesms.conversation.v2.groups.ConversationGroupViewModel
...
import org.stalker.securesms.conversation.v2.keyboard.AttachmentKeyboardFragment
...
import org.stalker.securesms.databinding.V2ConversationFragmentBinding
import org.stalker.securesms.dependencies.ApplicationDependencies
import org.stalker.securesms.events.GroupCallPeekEvent
import org.stalker.securesms.events.ReminderUpdateEvent
...
import org.stalker.securesms.groups.ui.GroupErrors
import org.stalker.securesms.groups.ui.LeaveGroupDialog
import org.stalker.securesms.groups.ui.invitesandrequests.ManagePendingAndRequestingMembersActivity
import org.stalker.securesms.groups.ui.invitesandrequests.invite.GroupLinkInviteFriendsBottomSheetDialogFragment
import org.stalker.securesms.groups.ui.managegroup.dialogs.GroupDescriptionDialog
import org.stalker.securesms.groups.ui.migration.GroupsV1MigrationInfoBottomSheetDialogFragment
import org.stalker.securesms.groups.ui.migration.GroupsV1MigrationSuggestionsDialog
import org.stalker.securesms.groups.v2.GroupBlockJoinRequestResult
import org.stalker.securesms.invites.InviteActions
import org.stalker.securesms.keyboard.KeyboardPage
import org.stalker.securesms.keyboard.KeyboardPagerFragment
...
import org.stalker.securesms.keyboard.gif.GifKeyboardPageFragment
...
import org.stalker.securesms.linkpreview.LinkPreviewViewModelV2
import org.stalker.securesms.longmessage.LongMessageFragment
import org.stalker.securesms.mediaoverview.MediaOverviewActivity
import org.stalker.securesms.mediapreview.MediaIntentFactory
import org.stalker.securesms.mediapreview.MediaPreviewV2Activity
import org.stalker.securesms.mediasend.Media
import org.stalker.securesms.mediasend.MediaSendActivityResult
import org.stalker.securesms.messagedetails.MessageDetailsFragment
import org.stalker.securesms.messagerequests.MessageRequestRepository
import org.stalker.securesms.mms.AttachmentManager
...
import org.stalker.securesms.mms.SlideFactory
import org.stalker.securesms.mms.StickerSlide
...
import org.stalker.securesms.profiles.manage.EditProfileActivity
import org.stalker.securesms.profiles.spoofing.ReviewCardDialogFragment
import org.stalker.securesms.providers.BlobProvider
import org.stalker.securesms.ratelimit.RecaptchaProofBottomSheetFragment
import org.stalker.securesms.ratelimit.RecaptchaRequiredEvent
import org.stalker.securesms.reactions.ReactionsBottomSheetDialogFragment
import org.stalker.securesms.reactions.any.ReactWithAnyEmojiBottomSheetDialogFragment
import org.stalker.securesms.recipients.Recipient
import org.stalker.securesms.recipients.RecipientExporter
import org.stalker.securesms.recipients.RecipientId
import org.stalker.securesms.recipients.ui.bottomsheet.RecipientBottomSheetDialogFragment
import org.stalker.securesms.recipients.ui.disappearingmessages.RecipientDisappearingMessagesActivity
import org.stalker.securesms.registration.RegistrationNavigationActivity
import org.stalker.securesms.revealable.ViewOnceMessageActivity
import org.stalker.securesms.revealable.ViewOnceUtil
...
import org.stalker.securesms.stickers.StickerPackInstallEvent
import org.stalker.securesms.stickers.StickerPackPreviewActivity
...
import org.stalker.securesms.util.DeleteDialog
...
import org.stalker.securesms.util.MessageConstraintsUtil.getEditMessageThresholdHours
import org.stalker.securesms.util.MessageConstraintsUtil.isValidEditMessageSend
import org.stalker.securesms.util.PlayStoreUtil
import org.stalker.securesms.util.SaveAttachmentUtil
...
import org.stalker.securesms.util.atMidnight
import org.stalker.securesms.util.atUTC
import org.stalker.securesms.util.createActivityViewModel
import org.stalker.securesms.util.doAfterNextLayout
import org.stalker.securesms.util.fragments.requireListener
import org.stalker.securesms.util.getRecordQuoteType
import org.stalker.securesms.util.hasAudio
import org.stalker.securesms.util.hasGiftBadge
import org.stalker.securesms.util.hasNonTextSlide
import org.stalker.securesms.util.isValidReactionTarget
import org.stalker.securesms.util.padding
import org.stalker.securesms.util.savedStateViewModel
...
import org.stalker.securesms.verify.VerifyIdentityActivity
import org.stalker.securesms.wallpaper.ChatWallpaper
import org.stalker.securesms.wallpaper.ChatWallpaperDimLevelUtil
