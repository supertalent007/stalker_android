...
import org.stalker.securesms.database.model.ServiceMessageId
...
/**
 * A job that should be enqueued whenever we process a message that we think has arrived "early" (see [org.stalker.securesms.util.EarlyMessageCache]).
