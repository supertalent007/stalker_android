...
class SyncSystemContactLinksJob private constructor(parameters: Parameters) : BaseJob(parameters) {
  ...
  companion object {
    ...
    private const val MESSAGE_MIMETYPE = "vnd.android.cursor.item/vnd.org.stalker.securesms.contact"
    private const val CALL_MIMETYPE = "vnd.android.cursor.item/vnd.org.stalker.securesms.call"
    private const val VIDEO_CALL_MIMETYPE = "vnd.android.cursor.item/vnd.org.stalker.securesms.videocall"
