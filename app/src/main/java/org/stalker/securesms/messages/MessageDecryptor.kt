...
import org.stalker.securesms.jobs.SendRetryReceiptJob
...
object MessageDecryptor {
   ...
   * These can vary from enqueueing jobs to inserting items into the [org.stalker.securesms.database.PendingRetryReceiptCache].
   */
  fun decrypt(
    context: Context,
