...
import org.stalker.securesms.registration.v2.data.network.VerificationCodeRequestResult.AttemptsExhausted
import org.stalker.securesms.registration.v2.data.network.VerificationCodeRequestResult.ChallengeRequired
import org.stalker.securesms.registration.v2.data.network.VerificationCodeRequestResult.ExternalServiceFailure
import org.stalker.securesms.registration.v2.data.network.VerificationCodeRequestResult.ImpossibleNumber
import org.stalker.securesms.registration.v2.data.network.VerificationCodeRequestResult.InvalidTransportModeFailure
import org.stalker.securesms.registration.v2.data.network.VerificationCodeRequestResult.MalformedRequest
import org.stalker.securesms.registration.v2.data.network.VerificationCodeRequestResult.MustRetry
import org.stalker.securesms.registration.v2.data.network.VerificationCodeRequestResult.NonNormalizedNumber
import org.stalker.securesms.registration.v2.data.network.VerificationCodeRequestResult.RateLimited
import org.stalker.securesms.registration.v2.data.network.VerificationCodeRequestResult.Success
import org.stalker.securesms.registration.v2.data.network.VerificationCodeRequestResult.TokenNotAccepted
import org.stalker.securesms.registration.v2.data.network.VerificationCodeRequestResult.UnknownError
