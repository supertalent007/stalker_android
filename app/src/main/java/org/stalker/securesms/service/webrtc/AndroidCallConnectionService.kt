...
class AndroidCallConnectionService : ConnectionService() {
  ...
  companion object {
    ...
    const val KEY_RECIPIENT_ID = "org.stalker.securesms.RECIPIENT_ID"
    const val KEY_CALL_ID = "org.stalker.securesms.CALL_ID"
    const val KEY_VIDEO_CALL = "org.stalker.securesms.VIDEO_CALL"
  }
