...
import org.stalker.securesms.components.settings.app.appearance.appicon.util.AppIconUtility;
...
import org.stalker.securesms.jobs.ConversationShortcutUpdateJob;
...
public final class ConversationUtil {
  ...
  private static final String CATEGORY_SHARE_TARGET = "org.stalker.securesms.sharing.CATEGORY_SHARE_TARGET";
