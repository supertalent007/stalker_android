...
class ProxySQLCipherOpenHelper(
  ...
  override val signalReadableDatabase: org.stalker.securesms.database.SQLiteDatabase
    get() = ProxySignalSQLiteDatabase(readableDatabase)

  override val signalWritableDatabase: org.stalker.securesms.database.SQLiteDatabase
