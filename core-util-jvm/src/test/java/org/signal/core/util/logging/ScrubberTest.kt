  ...
  companion object {
    ...
    fun data(): Iterable<Array<Any>> {
      return listOf(
        ...
        arrayOf(
          "An avatar filename: file:///data/user/0/org.stalker.securesms/files/avatars/%2B447700900099",
          "An avatar filename: file:///data/user/0/org.stalker.securesms/files/avatars/E164:<3106a>"
        ),
        arrayOf(
        ...
        arrayOf(
          "An avatar email filename: file:///data/user/0/org.stalker.securesms/files/avatars/abc@signal.org",
          "An avatar email filename: file:///data/user/0/org.stalker.securesms/files/avatars/a...@..."
        ),
        arrayOf(
