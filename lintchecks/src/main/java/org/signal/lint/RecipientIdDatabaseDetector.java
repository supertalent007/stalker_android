...
public final class RecipientIdDatabaseDetector extends Detector implements SourceCodeScanner {
  ...
  private static final Set<String> EXEMPTED_CLASSES = new HashSet<>() {{
    add("org.stalker.securesms.database.RecipientDatabase");
  }};
  ...
  public UElementHandler createUastHandler(@NotNull JavaContext context) {
    return new UElementHandler() {
      ...
      public void visitClass(@NotNull UClass node) {
        ...
        boolean implementsReference = Arrays.stream(node.getInterfaces()).anyMatch(i -> "org.stalker.securesms.database.RecipientIdDatabaseReference".equals(i.getQualifiedName()));
